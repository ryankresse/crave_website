...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		...
		<div class = "logo-secondary-container clear">
			<div class = "logo">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>"  title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri();?>/images/crave_logo.jpg" class = "logo-image" alt="linkedin icon" ></a>
			</div><!--logo-->
			...
			<nav class = "secondary-navigation" role = "navigation">
				...
				<ul>
					...
					<li class = "secondary-nav-icons">
						<a href= "http://www.yelp.com/biz/crave-gourmet-baskets-and-gifts-lake-charles-2"> 
							<img src="<?php echo get_template_directory_uri();?>/images/yelp-favicons.png" alt="Find us on Yelp" >
						</a>
					</li>
					<li class = "secondary-nav-icons">
						<a href="https://www.facebook.com/CraveLakeCharles">
		...
		<nav id="site-navigation" class="main-navigation" role="navigation">
			<button class="menu-toggle"><?php _e( '', 'twentytwelve' ); ?></button>
